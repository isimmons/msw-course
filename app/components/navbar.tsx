...
import {
  RiHome8Line as HomeIcon,
  RiVidicon2Line as CameraIcon,
  RiTicket2Line as TicketIcon,
  RiArrowLeftCircleLine as SignInIcon,
  RiArrowRightCircleLine as SignOutIcon,
